...
class EmploymentRequest extends Model {
  ...
  const EmploymentRequest._internal({required this.id, employerWallet, employeeWallet, start, end, required dayPerMonth, required hourPerDay, required periodMonth, required currency, required price, progressStatus, extended, lockMonth, vestingMonth, agreementId, reputation, createdAt, updatedAt}): _employerWallet = employerWallet, _employeeWallet = employeeWallet, _start = start, _end = end, _dayPerMonth = dayPerMonth, _hourPerDay = hourPerDay, _periodMonth = periodMonth, _currency = currency, _price = price, _progressStatus = progressStatus, _extended = extended, _lockMonth = lockMonth, _vestingMonth = vestingMonth, _agreementId = agreementId, _reputation = reputation, _createdAt = createdAt, _updatedAt = updatedAt;
  ...
  String toString() {
    ...
    buffer.write("reputation=" + (_reputation != null ? _reputation!.toString() : "null") + ", ");
  ...
  EmploymentRequest copyWith({String? id, String? employerWallet, String? employeeWallet, TemporalDateTime? start, TemporalDateTime? end, int? dayPerMonth, double? hourPerDay, int? periodMonth, String? currency, int? price, String? progressStatus, String? extended, int? lockMonth, int? vestingMonth, String? agreementId, int? reputation}) {
    return EmploymentRequest._internal(
      id: id ?? this.id,
  ...
  static final QueryField REPUTATION = QueryField(fieldName: "reputation");
  static var schema = Model.defineSchema(define: (ModelSchemaDefinition modelSchemaDefinition) {
    ...
    modelSchemaDefinition.addField(ModelFieldDefinition.field(
      key: EmploymentRequest.REPUTATION,
      isRequired: false,
      ofType: ModelFieldType(ModelFieldTypeEnum.int)
    ));
